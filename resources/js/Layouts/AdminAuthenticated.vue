            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <breeze-nav-link :href="route('transactions.index')" :active="route().current('transactions.index')">
                                    Transaction
                                </breeze-nav-link>
                                <breeze-nav-link :href="route('points.index')" :active="route().current('points.index')">
                                    Reward Points
                                </breeze-nav-link>
                                <breeze-nav-link :href="route('rewards.index')" :active="route().current('rewards.index')">
                                    Reward
                                </breeze-nav-link>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <breeze-responsive-nav-link :href="route('transactions.index')" :active="route().current('transactions.index')">
                            Transaction
                        </breeze-responsive-nav-link>
                        <breeze-responsive-nav-link :href="route('points.index')" :active="route().current('points.index')">
                            Reward Points
                        </breeze-responsive-nav-link>
                        <breeze-responsive-nav-link :href="route('rewards.index')" :active="route().current('rewards.index')">
                            Rewards
                        </breeze-responsive-nav-link>
                    </div>
